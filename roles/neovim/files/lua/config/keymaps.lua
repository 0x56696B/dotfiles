...
vim.keymap.del("n", "<C-/>") -- normal mode terminal toggle
vim.keymap.del("t", "<C-/>") -- terminal mode escape
vim.keymap.del("n", "<leader>ft") -- LazyVim terminal toggle
vim.keymap.del("n", "<leader>fT") -- LazyVim terminal toggle
vim.keymap.del("n", "<C-_>") -- LazyVim terminal toggle
